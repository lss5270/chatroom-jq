$(function(){
	...
	function showMessage(data){
		...
		if(data.username === uname){
			...
			html='<div class="chat-item item-left clearfix rela"><span class="abs uname">'+data.username+'  ('+formatDate(data.msgDate)+')'+'</span><span class="img fl"></span><span class="fl message">'+data.message+'</span></div>'
		}
		$('.chat-con').append(html);
